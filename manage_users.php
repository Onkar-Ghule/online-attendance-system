    ...
    if (isset($_POST['add_user'])) {
        ...
        if ($role == 'professor') {
            ...
            if (isset($_POST['ema'], $_POST['department'], $_POST['phone'], $_POST['address'])) {
                ...
                echo "Email: $email, Department: $department"; 
            ...
            if (isset($_POST['course'], $_POST['year'], $_POST['section'], $_POST['email'], $_POST['contact_number'], $_POST['attendance_record'], $_POST['total_attendance'])) {
                ...
                $attendance_record = pg_escape_string($db, $_POST['attendance_record']);
                $total_attendance = pg_escape_string($db, $_POST['total_attendance']);

                $query = "INSERT INTO student (id, name, password, course, year, section, email, contact_number, attendance_record, total_attendance)
                        VALUES ('$id', '$username', '$hashed_password', '$course', '$year', '$section', '$email', '$contact_number', '$attendance_record', '$total_attendance')";
                $result = pg_query($db, $query);
            } else {
    ...
    <body>
        ...
        <div id="student-fields" style="display:none;">
            ...
            <input type="text" name="attendance_record" placeholder="Attendance Record">
            <input type="text" name="total_attendance" placeholder="Total Attendance">
        </div>
...
<?php if (isset($user)): ?>
    <h3>User Found: <?php echo ucfirst($user_type); ?></h3>
    ...
    if ($user_type == "professor") {
        ...
        echo "<table>
                ...
                <tr>
                    ...
                    <td>$user[year]</td>
                    <td>$user[section]</td>
                    <td>$user[attendance_record]</td>
                    <td>$user[total_attendance]</td>
                </tr>
            </table>";
    }
    ?>
...
<?php endif; ?>
    ...
    <form action="manage_users.php" method="post">
        ...
        <select name="update_field" id="update_field" required>
            ...
            <!-- Add more options based on the fields you want to allow updating -->
        </select>
    ...
    <form action="manage_users.php" method="post">  
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $student['attendance_record']; ?></td>
